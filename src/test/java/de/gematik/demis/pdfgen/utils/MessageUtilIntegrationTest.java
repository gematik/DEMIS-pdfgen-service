...
class MessageUtilIntegrationTest {
  ...
  @Test
  void getOrDefault_shouldReturnValue() {
    // when
    String value1 = MessageUtil.getOrDefault("bed-occupancy.beds.occupied.adult", "defaultValue");
    String value2 = MessageUtil.getOrDefault("non existing key", "defaultValue");
    // then
    assertThat(value1).isEqualTo("Erwachsene");
    assertThat(value2).isEqualTo("defaultValue");
  }
}
