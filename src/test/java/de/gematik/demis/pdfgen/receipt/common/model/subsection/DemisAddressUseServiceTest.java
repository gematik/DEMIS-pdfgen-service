...
public final class DemisAddressUseServiceTest {
  ...
  void setDemisAddressUse() {
    this.demisAddressUseService = new DemisAddressUseService(this.translationAddressProvider);
  }
  ...
  void toStringShouldTranslate() {
    Mockito.when(this.translationAddressProvider.translateUse(Mockito.any()))
