...
import static de.gematik.demis.pdfgen.utils.StringUtils.*;
...
@Getter
@Builder
public class BedOccupancyAddress {
  ...
  public String getFullAddressAsSingleLine() {
    String postalCodeAndCity = concatenateWithDelimiter(SPACE, postalCode, city);
