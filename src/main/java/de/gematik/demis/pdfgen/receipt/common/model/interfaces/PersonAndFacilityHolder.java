...
public abstract class PersonAndFacilityHolder {
  protected abstract Person getPerson();

  protected abstract Facility getFacility();

  public final boolean hasPerson() {
    return getPerson() != null && getPerson().isNotEmpty();
  }

  public final boolean hasFacility() {
    return getFacility() != null && getFacility().isNotEmpty();
  }
}
