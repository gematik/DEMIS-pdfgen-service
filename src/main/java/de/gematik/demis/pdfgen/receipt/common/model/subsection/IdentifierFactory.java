...
public class IdentifierFactory {
  ...
  private static void applyBsnrAndDemisId(
    ...
    if (system.equals(BSNR_ORGANIZATION_ID)) {
      builder.bsnr(fhirIdentifier.getValue());
    } else if (system.equals(DEMIS_LABORATORY_ID) || system.equals(DEMIS_PARTICIPANT_ID)) {
      builder.demisId(fhirIdentifier.getValue());
    }
  }
