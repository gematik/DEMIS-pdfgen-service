...
public class LaboratoryReportController {
  ...
  public LaboratoryReportController(LaboratoryReportService service) {
  ...
  public ResponseEntity<byte[]> generatePdfFromBundleJsonString(
    ...
    log.info("incoming pdf generation request with json body");
  ...
  public ResponseEntity<byte[]> generatePdfFromBundleXmlString(
    ...
    log.info("incoming pdf generation request with xml body");
